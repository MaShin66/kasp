...
<?
	...
	while($com_row = mysql_fetch_array($result)){
		...
		if(img_type(WIZHOME_PATH."/data/member/".$memid."_icon.gif")) $icon = "<img src='/admin2/data/member/".$memid."_icon.gif' align='absmiddle' width='20' height='20'>";
		else if(img_type(WIZHOME_PATH."/data/member/".$memid."_icon.jpg")) $icon = "<img src='/admin2/data/member/".$memid."_icon.jpg' align='absmiddle' width='20' height='20'>";
		else $icon = "";
