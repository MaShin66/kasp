...
function searchMem(){
	...
	window.open("<?=$skin_dir?>/mem_search.php","searchMem","width=427, height=280, menubar=no, scrollbars=yes, resizable=no, toolbar=no, status=no, top=100, left=100");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <?=$hide_admin_start?>
  <tr>
    <td align="center" height="30" bgcolor="#f9f9f9" style="padding-left:10px; border-right:1px solid #d7d7d7;"><strong>회원선택</strong></td>
    <td align="left" colspan="3" style="padding-left:10px;"><input name="memid" value="<?=$bbs_row[memid]?>" type="text" size="20" class="input" onClick="searchMem();" readonly/> <a href="javascript:searchMem();">[선택]</a></td>
  </tr>
  <tr>
    <td colspan="4" height="1" bgcolor="#d7d7d7"></td>
  </tr>
  ...
  <tr>
    ...
    <td align="left" colspan="3" style="padding-left:10px;"><input name="subject" value="<?=$subject?>" type="text" size="60" class="input" /></td>
  </tr>
  <tr>
    <td colspan="4" height="1" bgcolor="#d7d7d7"></td>
  </tr>
