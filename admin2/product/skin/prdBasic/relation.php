    ...
    <td align="left">
	      ...
	      <tr valign="top">
				...
				while($rel_row = mysql_fetch_object($rel_result)) {
					...
					// 상품 이미지
					if(!@file($_SERVER[DOCUMENT_ROOT]."/admin2/data/product/".$rel_row->prdimg_R)) $rel_row->prdimg_R = $skin_dir."/image/noimg_R.gif";
					else $rel_row->prdimg_R = "/admin2/data/product/".$rel_row->prdimg_R;
