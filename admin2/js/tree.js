...
var TREE_NODE_ROOT_IMG = "/admin2/manage/image/tree/Common_TreeNode_FolderRoot.gif";
var TREE_FOLDER_OPEN_IMG = "/admin2/manage/image/tree/Common_TreeNode_FolderOpen.gif";
var TREE_FOLDER_CLOSED_IMG = "/admin2/manage/image/tree/Common_TreeNode_FolderClosed.gif";

var TREE_LINE_OPEN_IMG = "/admin2/manage/image/tree/Common_TreeNode_LineNodeOpen.gif";
var TREE_LINE_CLOSED_IMG = "/admin2/manage/image/tree/Common_TreeNode_LineNodeClosed.gif";
var TREE_LINE_LAST_IMG = "/admin2/manage/image/tree/Common_TreeNode_LineLast.gif";
var TREE_LINE_LAST_OPEN_IMG = "/admin2/manage/image/tree/Common_TreeNode_LineLastOpen.gif";
var TREE_LINE_LAST_CLOSED_IMG = "/admin2/manage/image/tree/Common_TreeNode_LineLastClosed.gif";

var TREE_LINE_NODE_IMG = "/admin2/manage/image/tree/Common_TreeNode_LineNode.gif";
var TREE_LINE_VERT_IMG = "/admin2/manage/image/tree/Common_TreeNode_LineVert.gif";
var TREE_LINE_BLANK = "/admin2/manage/image/tree/Common_TreeNode_Blank.gif";

var TREE_NODE_LEAF_IMG = "/admin2/manage/image/tree/Common_TreeNode_Note.gif";

var TREE_NODE_MMATOP_IMG= "/admin2/manage/image/tree/MMAReport_Top_Root.gif";
...
{
	TREE_NODE_ROOT_IMG = "/admin2/manage/image/tree/Common_TreeNode_FolderRoot.gif";
	TREE_FOLDER_OPEN_IMG = "/admin2/manage/image/tree/Common_TreeNode_FolderOpen.gif";
	TREE_FOLDER_CLOSED_IMG = "/admin2/manage/image/tree/Common_TreeNode_FolderClosed.gif";

	TREE_LINE_OPEN_IMG = "/admin2/manage/image/tree/Common_TreeNode_LineNodeOpen.gif";
	TREE_LINE_CLOSED_IMG = "/admin2/manage/image/tree/Common_TreeNode_LineNodeClosed.gif";
	TREE_LINE_LAST_IMG = "/admin2/manage/image/tree/Common_TreeNode_LineLast.gif";
	TREE_LINE_LAST_OPEN_IMG = "/admin2/manage/image/tree/Common_TreeNode_LineLastOpen.gif";
	TREE_LINE_LAST_CLOSED_IMG = "/admin2/manage/image/tree/Common_TreeNode_LineLastClosed.gif";

	TREE_LINE_NODE_IMG = "/admin2/manage/image/tree/Common_TreeNode_LineNode.gif";
	TREE_LINE_VERT_IMG = "/admin2/manage/image/tree/Common_TreeNode_LineVert.gif";
	TREE_LINE_BLANK = "/admin2/manage/image/tree/Common_TreeNode_Blank.gif";

	TREE_NODE_LEAF_IMG = "/admin2/manage/image/tree/Common_TreeNode_Note.gif";

	TREE_NODE_MMATOP_IMG= "/admin2/manage/image/tree/MMAReport_Top_Root.gif";
}
