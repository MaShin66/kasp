...
<table width="510" align="center" border="0" cellspacing="0" cellpadding="2">
  <tr>
    <td class="tit"><img src="./manage/image/ic_tit.gif" align="absmiddle">라이센스키 &nbsp; 홈페이지 솔루션(위즈홈UTF)</td>
  </tr>
  <tr><td height="5"></td></tr>
</table>
<table width="510" align="center" border="0" cellspacing="1" cellpadding="0" class="t_style">
<form name="frm" action="/admin2/install_ok.php" method="post" onSubmit="return inputCheck(this);">
