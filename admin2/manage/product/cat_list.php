...
function onReload()
{
	...
	/*	Create Root node	*/
	var rootnode = new TreeNode(" 최상위 ", "/admin2/manage/image/tree/ServerMag_Etc_Root.gif","/admin2/manage/image/tree/ServerMag_Etc_Root.gif");
	...
	while($row = mysql_fetch_object($result)){
		...
		if($row->depthno == 1){
			...
			echo "var subnode_$catcode3 = new TreeNode(\"$row->catname\", \"/admin2/manage/image/tree/Common_TreeNode_Note.gif\", \"/admin2/manage/image/tree/Common_TreeNode_Note.gif\");\n";
