...
-->
      ...
      <table width="100%" cellspacing="1" cellpadding="3" border="0" class="t_style">
      	<tr>
		      <td width="120" class="t_name">&nbsp; 분석방법</td>
		      <td class="t_value">
      	...
      	<tr>
		     ...
		     ?>
      		...
      		<img src="../image/btn_conreset.gif" align="absmiddle" style="cursor:hand" onClick="delConnect();">
      		</td>
      	</tr>
    	</table>
		</form>

			<table height="340" border='0' cellspacing='0' cellpadding='0' background="../image/connect_graph.gif">
				<tr>
					<td width=50></td>
