          ...
          <td>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="6" class="t_style">
              <tr>
                ...
                <?
                $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/join.php\";     // 회원가입 ?&gt;";
                ?>
                <script language="javascript">
                ...
                <td class="t_value">
                <?
                $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/login.php\";     // 로그인페이지 ?&gt;";
                ?>
                <script language="javascript">
              ...
              <tr>
                ...
                <td class="t_value">
                <?
                $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/idpw.php\";     // 아이디/비번찾기 ?&gt;";
                ?>
                <script language="javascript">
              ...
              <tr>
                ...
                <td class="t_value">
                <?
                $php_code = "&lt;? \$stype=\"id\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/idpw.php\";     // 아이디찾기 ?&gt;";
                ?>
                <script language="javascript">
              ...
              <tr>
                ...
                <td class="t_value">
                <?
                $php_code = "&lt;? \$stype=\"pw\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/idpw.php\";     // 비밀번호찾기 ?&gt;";
                ?>
                <script language="javascript">
              ...
              <tr>
                ...
                <td class="t_value">
                <?
                $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/myinfo.php\";     // 회원정보수정 ?&gt;";
                ?>
                <script language="javascript">
              ...
              <tr>
                ...
                <td class="t_value">
                <?
                $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/myout.php\";     // 회원탈퇴 ?&gt;";
                ?>
                <script language="javascript">
              ...
              <tr>
                ...
                <td class="t_value">
                <?
                $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/loginbox.php\";     // 로그인박스 ?&gt;";
                ?>
                <script language="javascript">
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="6" class="t_style">
              <tr>
                ...
                <td width="85%" class="t_value">
                <?
                $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/toplogin.php\";     // 로그인,로그아웃 ?&gt;";
                ?>
                <script language="javascript">
              ...
              <tr>
                ...
                <td class="t_value">
                <?
                $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/topjoin.php\";     // 회원가입,정보수정 ?&gt;";
                ?>
                <script language="javascript">
