...
-->
      ...
      <input type="hidden" name="idx" value="<?=$idx?>">
        ...
        <tr>
          ...
          <td class="t_value" align="left">
          <?
          $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/msg_receive.php\";     // 받은쪽지 ?&gt;";
          ?>
          <script language="javascript">
        ...
        <tr>
          ...
          <td class="t_value" align="left">
          <?
          $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/msg_send.php\";     // 보낸쪽지 ?&gt;";
          ?>
          <script language="javascript">
        ...
        <tr>
          ...
          <td class="t_value" align="left">
          <?
          $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/msg_member.php\";     // 회원목록 ?&gt;";
          ?>
          <script language="javascript">
        ...
        <tr>
          ...
          <td class="t_value" align="left">
          <?
          $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/msg_friend.php\";     // 친구목록 ?&gt;";
          ?>
          <script language="javascript">
        ...
        <tr>
          ...
          <td class="t_value" align="left">
          <?
          $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/msg_count.php\";     // 쪽지개수 ?&gt;";
          ?>
          <script language="javascript">
