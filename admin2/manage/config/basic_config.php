        ...
        <tr>
          <td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="2">
                  ...
                  <img src="../image/btn_dbdesc.gif" style="cursor:hand" onClick="window.open('/admin2/desc_table.php?mode=print','','');">
                  <img src="../image/btn_filedesc.gif" style="cursor:hand" onClick="window.open('/admin2/desc_file.php?mode=print','','');">
			          </td>
			        </tr>
			      </table>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="3" class="t_style">
              <tr>
                ...
                <td width="85%" class="t_value">
                <? if(is_file(WIZHOME_PATH."/data/config/admin_logo.gif")) echo "<br><img src='/admin2/data/config/admin_logo.gif'><br><br>"; ?>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="3" class="t_style">
              <tr>
                ...
                <td width="85%" class="t_value">
                	<table>
                	<tr><td>기본페이지 : /admin2/manage/main/main.php</td></tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="6">
              ...
              <tr>
                <td><font color=red>주의) 신청후 받은 cb_namecheck 파일을 /admin2/member 폴더에 업로드(<b>전송타입 꼭 바이너리</b>)후 707퍼미션을 줍니다.</font></td>
              </tr>
            </table>
