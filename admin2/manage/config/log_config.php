          ...
          <td>
            <table width="100%" border="0" cellspacing="1" cellpadding="6" class="t_style">
              <tr>
                ...
                <?
                $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/connect.php\";     // 로그분석 ?&gt;";
                ?>
...
<font color=#0000FF>&lt;? include "$_SERVER[DOCUMENT_ROOT]/admin2/module/connect.php";     // 로그분석 ?&gt;</font><br>
