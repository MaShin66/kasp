...
-->
      ...
      <input type="hidden" name="idx" value="<?=$idx?>">
        ...
        <!--tr>
          ...
          <td class="t_value" align="left">
          <?
          $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/mini/mini_main.php\";     // 메인 페이지 ?&gt;";
          ?>
          <script language="javascript">
        ...
        <tr>
          ...
          <td class="t_value" align="left">
          <?
          $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/mini/mini_my.php\";     // 내 미니홈피가기 ?&gt;";
          ?>
          <script language="javascript">
          function copy_Phpcode1(){
          	var php_code = "<?=str_replace("\"","\\\"",$php_code)?>";
...
&nbsp; &lt;tr&gt;<br>
&nbsp; &nbsp; &lt;td align="center"&gt;<br>
&nbsp; &nbsp; <font color=#0000FF>&lt;? include "$_SERVER[DOCUMENT_ROOT]/admin2/mini/mini_my.php";     // 내 미니홈피가기 ?&gt;</font><br>
