...
function phpCode(code){
	var php_code = "&lt;? \$code=\""+code+"\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/bbs.php\"; // 게시판 ?&gt;";
	set_ClipBoard(php_code);
}
function insertBbs(){
	var uri = "/admin2/manage/bbs/bbs_input.php?mode=insert";
          ...
          <td>
            <table width="100%" border="0" cellspacing="1" cellpadding="6" class="t_style">
              <tr>
                ...
                <?
                $php_code = "&lt;? \$code=\"qna\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/bbs.php\";     // 게시판 ?&gt;";
                ?>
