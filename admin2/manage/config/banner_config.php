...
function phpCode(code){
	var php_code = "&lt;? \$code=\""+code+"\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/banner.php\"; ?&gt;";
          ...
          <td>
            <table width="100%" border="0" cellspacing="1" cellpadding="6" class="t_style">
              <tr>
                ...
                <?
                $php_code = "&lt;? \$code=\"banner01\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/banner.php\";     // 배너 ?&gt;";
                ?>
                <script language="javascript">
