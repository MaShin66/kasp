          ...
          <td>
            <table width="100%" border="0" cellspacing="1" cellpadding="6" class="t_style">
              <tr>
                ...
                <?
                $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/counter.php\";     // 카운터 ?&gt;";
                ?>
...
&nbsp; &lt;tr&gt;<br>
&nbsp; &nbsp; &lt;td align="center"&gt;<br>
&nbsp; &nbsp; <font color=#0000FF>&lt;? include "$_SERVER[DOCUMENT_ROOT]/admin2/module/counter.php";     // 카운터 ?&gt;</font><br>
