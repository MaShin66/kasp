...
function phpCode(code){
	var php_code = "&lt;? \$code=\""+code+"\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/form.php\"; ?&gt;";
          ...
          <td>
            <table width="100%" border="0" cellspacing="1" cellpadding="6" class="t_style">
              <tr>
                ...
                <?
                $php_code = "&lt;? \$code = \"contact\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/form.php\"; // 폼메일 ?&gt;";
                ?>
                <script language="javascript">
