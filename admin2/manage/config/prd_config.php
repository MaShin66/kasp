...
<? include_once "$_SERVER[DOCUMENT_ROOT]/admin2/inc/prd_info.php"; ?>
<?
if($save == "ok"){
...
function phpCode(idx){
	var php_code = "&lt;? \$pidx=\""+idx+"\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/prdmain.php\"; // 상품추출 ?&gt;";
          ...
          <td>
            <table width="100%" border="0" cellspacing="1" cellpadding="6" class="t_style">
              <tr>
                ...
                <?
                $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/product.php\";     // 상품관리 ?&gt;";
                ?>
                <script language="javascript">
