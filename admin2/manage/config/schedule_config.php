...
function phpCode(code){
	var php_code = "&lt;? \$code=\""+code+"\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/schedule.php\"; // 일정관리(대) ?&gt;";
	set_ClipBoard(php_code);
}
function phpCode2(code){
	var php_code = "&lt;? \$code=\""+code+"\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/schedule_s.php\"; // 일정관리(소) ?&gt;";
	set_ClipBoard(php_code);
}
</script>
          ...
          <td>
            <table width="100%" border="0" cellspacing="1" cellpadding="6" class="t_style">
              <tr>
                ...
                <?
                $php_code = "&lt;? \$code=\"schedule\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/schedule.php\";     // 일정관리(대) ?&gt;";
                ?>
                <script language="javascript">
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="6" class="t_style">
              <tr>
                ...
                <?
                $php_code = "&lt;? \$code=\"schedule\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin2/module/schedule_s.php\";     // 일정관리(소) ?&gt;";
                ?>
                <script language="javascript">
