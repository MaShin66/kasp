...
<form name="loginboxFrm" action="<?=$ssl?>/admin2/member/login_check.php" method="post" onSubmit="return loginboxCheck(this)">
...
<form name="loginboxFrm" action="/admin2/member/login_check.php" method="post" onSubmit="return inputCheck(this)">
<input type="hidden" name="prev" value="<?=$self_page?>">
  <tr>
    <td>
