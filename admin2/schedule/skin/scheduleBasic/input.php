...
<form name="schFrm" action="<?=$PHP_SELF?>" method="post" enctype="multipart/form-data" onSubmit="return schCheck(this)">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <?=$hide_passwd_end?>
  <tr>
    <td align="center" height="30" bgcolor="#f9f9f9" style="padding-left:10px; border-right:1px solid #d7d7d7;"><strong>날짜 *</strong></td>
    <td align="left" colspan="3" style="padding-left:10px;">
    	<input name="wdate" value="<?=$wdate?>" type="text" size="15" class="input" />
    	<input type="button" value="달력" onClick="Calendar1('document.schFrm','wdate');" class="gbtn">
    </td>
  </tr>
  <tr>
    <td colspan="4" height="1" bgcolor="#d7d7d7"></td>
