...
function print_pagelist($page, $list_amount, $page_count, $param, $page_type = ""){
   ...
   if($skin_dir == "") $skin_dir = "/admin2/manage";
...
function get_spam_check(){
	...
	if (function_exists("imagecreate")) {	// 이미지 생성이 가능한 경우 자동등록체크코드를 이미지로 생성
	  $norobot_img = "<img src='/admin2/bbs/norobot_image.php?ss_norobot_key=$norobot_key' border='0' style='border: 1px solid #343d4f;' align='absmiddle'>";
	...
	?>
	<script Language="JavaScript" src="/admin2/js/md5.js"></script>
