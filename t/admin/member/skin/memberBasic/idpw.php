...
<div class="idpw_box">
	<div class="left box">
		...
		<form name="idfindFrm" action="<?=$ssl?>/admin/member/idpw.php" method="post" onSubmit="return idfindCheck(this);">
	...
	<div class="right box">
		...
		<form name="pwfindFrm" action="<?=$ssl?>/admin/member/idpw.php" method="post" onSubmit="return pwfindCheck(this);">
			<input type="hidden" name="search" value="ok">
