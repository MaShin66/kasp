...
function insertQuestion(){
	...
	window.open(url,"insertQuestion","height=450, width=450, menubar=no, scrollbars=yes, resizable=no, toolbar=no, status=no, top=100, left=100");
...
function editQuestion(idx){
	...
	window.open(url,"editQuestion","height=450, width=450, menubar=no, scrollbars=yes, resizable=no, toolbar=no, status=no, top=100, left=100");
...
<? include "../head.php"; ?>  
          ...
          <td>
            <table width="100%" border="0" cellspacing="1" cellpadding="6" class="t_style">
              ...
              <tr> 
                ...
                <br><img src="../image/btn_polldadd.gif" style="cursor:hand" onClick="insertQuestion();"><br>
					              ...
					              <tr> 
					                ...
					                <td valign=top width=100> 
					                  <table cellspacing=0 cellpadding=0 width="100%" border=0>
					                    <tr valign=center> 
					                      <td height=20>&nbsp; <?=$answer_list[$ii][1]?> 명/ <?=$answer_list[$ii][3]?> % </td>
					                    </tr>
					                  </table>
					                </td>
					              </tr>
      ...
      <? if(!strcmp($poll_info[comment], "Y") && !strcmp($mode, "update")){ ?>
      <br>
