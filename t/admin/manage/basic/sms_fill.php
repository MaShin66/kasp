...
-->
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td align="center">
         	<iframe src="http://www.icodekorea.com/res/userinfo.php?userid=<?=$site_info[sms_id]?>&userpw=<?=$site_info[sms_pw]?>&r_url=http://<?=$_SERVER[HTTP_HOST]?>/admin/manage/basic/sms_info.php" frameborder="0" width="100%" height="400"></iframe>
       </tr>
      </table>
