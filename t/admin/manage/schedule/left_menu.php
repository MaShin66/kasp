				...
				<tr> 
					<td background="../image/left_bg.gif" style="padding:0 12 3 15"> 
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr> 
								<td height="30"><img src="../image/left_m_arrow.gif" align="absmiddle"><a href="sch_list.php">일정관리</a></td>
							</tr>
							<tr> 
							...
							<tr> 
								<td height="30"><img src="../image/left_m_arrow.gif" align="absmiddle">일정목록</td>
							</tr>
							<?
			        ...
			        $result = mysql_query($sql) or error(mysql_error());
				      ...
				      <?
				    	...
				    	?>
				    	<tr> 
								<td height="20" style="padding-left:10px"><font color="red>등록된 일정이 없습니다.</font></td>
							</tr>
				    	<?
				    	}
				    	?>
