...
<?
	...
	while($row = mysql_fetch_array($result)){
		...
		if(!empty($row[upfile1])) $row[upfile1] = "http://".$_SERVER["HTTP_HOST"]."/admin/data/form/".$row[upfile1];
		if(!empty($row[upfile2])) $row[upfile1] = "http://".$_SERVER["HTTP_HOST"]."/admin/data/form/".$row[upfile2];
		if(!empty($row[upfile3])) $row[upfile1] = "http://".$_SERVER["HTTP_HOST"]."/admin/data/form/".$row[upfile3];
