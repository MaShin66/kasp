...
-->
      ...
      <input type="hidden" name="tmp">
        ...
        <tr>
          ...
          <td class="t_value" align="left">
          <?
          $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin/module/search.php\";     // 전체검색 ?&gt;";
          ?>
          <script language="javascript">
        ...
        <tr>
          ...
          <td class="t_value" align="left">
          <?
          $php_code = "&lt;? \$stype = \"bbs\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin/module/search_list.php\";     // 전체검색 페이지 ?&gt;";
          ?>
          <script language="javascript">
        ...
        <tr>
          ...
          <td class="t_value" align="left">
          <?
          $php_code = "&lt;? \$stype = \"prd\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin/module/search_list.php\";     // 전체검색 페이지 ?&gt;";
          ?>
          <script language="javascript">
        ...
        <tr>
          ...
          <td class="t_value" align="left">
          <?
          $php_code = "&lt;? \$stype = \"page\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin/module/search_list.php\";     // 전체검색 페이지 ?&gt;";
          ?>
          <script language="javascript">
