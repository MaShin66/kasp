...
function phpCode(code){
	var php_code = "&lt;? \$code=\""+code+"\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin/module/page.php\"; ?&gt;";
          ...
          <td>
            <table width="100%" border="0" cellspacing="1" cellpadding="6" class="t_style">
              <tr>
                ...
                <?
                $php_code = "&lt;? \$code=\"page01\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin/module/page.php\";     // 페이지 ?&gt;";
                ?>
                <script language="javascript">
