...
include "$_SERVER[DOCUMENT_ROOT]/admin/inc/prdmain_info.php";
...
while($row = mysql_fetch_array($result)){
	...
	if(file_exists(WIZHOME_PATH."/data/product/".$row[prdimg_R])) $prdimg = "/admin/data/product/".$row[prdimg_R];		// img
