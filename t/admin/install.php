...
<table width="510" align="center" border="0" cellspacing="0" cellpadding="2">
  <tr>
    <td class="tit"><img src="./manage/image/ic_tit.gif" align="absmiddle">위즈홈설치</td>
  </tr>
</table>
...
<table align="center">
	<tr>
		...
		?>
		<input type="image" src="./manage/image/btn_confirm_l.gif"> &nbsp;
		<img src="./manage/image/btn_cancel_l.gif" style="cursor:hand" onClick="document.frm.reset();">
		<?
		}else{
		?>
		<font color=red>현재 admin 폴더가 707로 퍼미션이 되어있지 않습니다.<br>텔넷이나 FTP에서 퍼미션을 조정하세요.<font><br>
