...
function print_pagelist($page, $list_amount, $page_count, $param, $page_type = ""){
   ...
   if($param != "") $param = "&".$param;
	...
	if($epage > 0) {
	   ...
	   echo "          <a href='$PHP_SELF?ptype=$ptype&$page_name=$ppage$param' class='prev_btn'><img src='$skin_dir/image/btn_prev.jpg'></a>";
	   ...
	   echo "</div>";
	   echo "          <a href='$PHP_SELF?ptype=$ptype&$page_name=$npage$param' class='next_btn'><img src='$skin_dir/image/btn_next.jpg'></a>";
