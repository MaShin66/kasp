...
if(img_type(WIZHOME_PATH."/data/member/".$memid."_icon.gif")) $icon = "<img src='/admin/data/member/".$memid."_icon.gif' align='absmiddle'>";
else if(img_type(WIZHOME_PATH."/data/member/".$memid."_icon.jpg")) $icon = "<img src='/admin/data/member/".$memid."_icon.jpg' align='absmiddle'>";
else $icon = "";
...
if($bbs_row[caticon] != "") $catname = "<img src='/admin/data/category/".$code."/".$bbs_row[caticon]."' align='absmiddle'> ";		// category
...
if(!strcmp($bbs_info[view_list], "Y")) {
	...
	include "$_SERVER[DOCUMENT_ROOT]/admin/bbs/list.php";
}
?>