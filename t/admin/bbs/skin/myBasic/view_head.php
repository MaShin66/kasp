...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <?=$hide_admin_start?>
  <tr>
    <td align="center" height="30" bgcolor="#f9f9f9" style="padding-left:10px; border-right:1px solid #d7d7d7;"><strong>회원</strong></td>
    <td colspan="3" align="left" style="padding-left:10px;"><?=$bbs_row[memid]?></td>
  </tr>
  <tr>
    <td colspan="4" height="1" bgcolor="#d7d7d7"></td>
  </tr>
