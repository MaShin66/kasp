...
INSERT INTO `wiz_filedesc` VALUES (1,'',''),(2,'/admin/member','회원관리'),(3,'/admin/member/join_save.php','회원정보저장 페이지'),(4,'/admin/member/join_input.php','회원입력 페이지'),(5,'/admin/member/loginbox.php','로그인박스'),(6,'/admin/bbs','게시판'),(7,'/admin/mini','미니홈피'),(8,'/admin/manage','관리자페이지'),(9,'/admin/bbs/down.php','첨부파일 다운로드'),(10,'/admin/bbs/copy.php','게시물복사'),(11,'/admin/bbs/move.php','게시물이동'),(12,'/admin/bbs/skin','스킨 디렉토리'),(13,'/admin/bbs/comment.php','코멘트'),(14,'/admin/bbs/input.php','입력페이지'),(15,'/admin/bbs/list.php','리스트페이지'),(16,'/admin/bbs/passwd.php','비밀번호체크'),(17,'/admin/bbs/save.php','데이타저장'),(18,'/admin/bbs/list_bak.php','리스트페이지 백업'),(19,'/admin/bbs/norobot_image.php','스팸글방지 이미지생성'),(20,'/admin/bbs/view.php','보기페이지'),(21,'/admin/bbs/view_img.php','첨부이미지 확대보기'),(22,'/admin/bbsmain','메인게시물'),(23,'/admin/bbsmain/image','이미지'),(24,'/admin/bbsmain/skin','스킨 디렉토리'),(25,'/admin/data','데이터 디렉토리'),(26,'/admin/form','폼메일'),(27,'/admin/form/skin','스킨 디렉토리'),(28,'/admin/form/input.php','폼메일 작성'),(29,'/admin/form/save.php','폼메일 저장'),(30,'/admin/inc','인클루드 디렉토리'),(31,'/admin/inc/admin_check.php','관리자 체크'),(32,'/admin/inc/bbs_info.php','게시판 정보'),(33,'/admin/inc/bbsmain_info.php','메인게시물 정보'),(34,'/admin/inc/class.sms.php','SMS 클래스'),(35,'/admin/inc/form_info.php','폼메일 정보'),(36,'/admin/inc/mem_info.php','회원설정 정보'),(37,'/admin/inc/msg_info.php','쪽지설정 정보'),(38,'/admin/inc/point_info.php','포인트설정 정보'),(39,'/admin/inc/poll_info.php','설문조사 정보'),(40,'/admin/inc/pollmain_info.php','메인설문조사 정보'),(41,'/admin/inc/prd_info.php','상품설정 정보'),(42,'/admin/inc/prdmain_info.php','메인상품 정보'),(43,'/admin/inc/sch_info.php','일정관리 정보'),(44,'/admin/inc/site_info.php','사이트 정보'),(45,'/admin/js','js 디렉토리'),(46,'/admin/mail','메일'),(47,'/admin/mail/img','메일 이미지'),(48,'/admin/manage/banner','배너관리'),(49,'/admin/manage/banner/banner_input.php','배너그룹 입력페이지'),(50,'/admin/manage/banner/banner_list.php','배너그룹 목록페이지'),(51,'/admin/manage/banner/banner_save.php','데이터 저장'),(52,'/admin/manage/banner/input.php','배너 입력페이지'),(53,'/admin/manage/banner/left_menu.php','좌측 메뉴'),(54,'/admin/manage/banner/list.php','배너 목록페이지'),(55,'/admin/manage/basic','기본설정'),(56,'/admin/manage/basic/admin_input.php','관리자 입력'),(57,'/admin/manage/basic/admin_list.php','관리자 목록'),(58,'/admin/manage/basic/admin_save.php','관리자 데이터 저장'),(59,'/admin/manage/basic/domain_input.php','도메인 입력'),(60,'/admin/manage/basic/email_input.php','이메일 입력'),(61,'/admin/manage/basic/left_menu.php','좌측메뉴'),(62,'/admin/manage/basic/popup_input.php','팝업 입력'),(63,'/admin/manage/basic/popup_list.php','팝업 목록'),(64,'/admin/manage/basic/popup_save.php','팝업 데이터 저장'),(65,'/admin/manage/basic/site_info.php','사이트 정보 입력'),(66,'/admin/manage/basic/site_save.php','사이트 정보 저장'),(67,'/admin/manage/basic/sms_fill.php','SMS 관리'),(68,'/admin/manage/basic/sms_info.php','SMS 충전내용'),(69,'/admin/manage/basic/sms_save.php','SMS 데이터 저장'),(70,'/admin/manage/bbs','게시판'),(71,'/admin/manage/bbs/bbs_input.php','게시판 입력'),(72,'/admin/manage/bbs/bbs_list.php','게시판 목록'),(73,'/admin/manage/bbs/bbs_save.php','게시판 데이터 저장'),(74,'/admin/manage/bbs/category.php','카테고리 목록'),(75,'/admin/manage/bbs/category_input.php','카테고리 입력'),(76,'/admin/manage/bbs/copy.php','게시물 복사'),(77,'/admin/manage/bbs/down.php','첨부파일 다운로드'),(78,'/admin/manage/bbs/input.php','게시물 입력'),(79,'/admin/manage/bbs/left_menu.php','좌측메뉴'),(80,'/admin/manage/bbs/list.php','게시물 목록'),(81,'/admin/manage/bbs/list_c.php','게시물 목록 스킨버전'),(82,'/admin/manage/bbs/move.php','게시물 이동'),(83,'/admin/manage/bbs/pop_view.php','게시물 보기 팝업'),(84,'/admin/manage/bbs/save.php','게시물 데이터 저장'),(85,'/admin/manage/bbs/view.php','게시물 보기'),(86,'/admin/manage/bbs/view_img.php','첨부이미지 확대보기'),(87,'/admin/manage/config','환경설정'),(88,'/admin/manage/config/banner_config.php','배너관리'),(89,'/admin/manage/config/basic_config.php','기본설정'),(90,'/admin/manage/config/basic_save.php','기본설정 저장'),(91,'/admin/manage/config/bbs_config.php','게시판 관리'),(92,'/admin/manage/config/bbsmain_config.php','메인게시물 관리'),(93,'/admin/manage/config/bbsmain_input.php','메인게시물 입력'),(94,'/admin/manage/config/bbsmain_save.php','메인게시물 저장'),(95,'/admin/manage/config/bbsmain_view.php','메인게시물 미리보기'),(96,'/admin/manage/config/counter_config.php','카운터'),(97,'/admin/manage/config/form_config.php','폼메일'),(98,'/admin/manage/config/form_field.php','폼메일 항목 목록'),(99,'/admin/manage/config/form_field_c.php','폼메일 항목 목록 백업'),(100,'/admin/manage/config/form_field_input.php','폼메일 항목 입력'),(101,'/admin/manage/config/form_input.php','폼메일 입력'),(102,'/admin/manage/config/form_save.php','폼메일 저장'),(103,'/admin/manage/config/form_save_c.php','폼메일 저장 백업'),(104,'/admin/manage/config/left_menu.php','좌측 메뉴'),(105,'/admin/manage/config/levelcheck_config.php','페이지접근권한'),(106,'/admin/manage/config/log_config.php','로그분석'),(107,'/admin/manage/config/member_config.php','회원설정'),(108,'/admin/manage/config/member_save.php','회원설정 저장'),(109,'/admin/manage/config/message_config.php','쪽지설정'),(110,'/admin/manage/config/message_save.php','쪽지설정 저장'),(111,'/admin/manage/config/mini_config.php','미니홈피 설정'),(112,'/admin/manage/config/mini_save.php','미니홈피 설정 저장'),(113,'/admin/manage/config/page_config.php','페이지 관리'),(114,'/admin/manage/config/point_config.php','포인트 설정'),(115,'/admin/manage/config/point_save.php','포인트 설정 저장'),(116,'/admin/manage/config/poll_config.php','설문조사 '),(117,'/admin/manage/config/poll_config_b.php','설문조사 백업'),(118,'/admin/manage/config/pollmain_config.php','메인설문조사'),(119,'/admin/manage/config/pollmain_input.php','메인설문조사 입력'),(120,'/admin/manage/config/pollmain_save.php','메인설문조사 저장'),(121,'/admin/manage/config/popup_config.php','팝업관리'),(122,'/admin/manage/config/prdmain_input.php','메인 상품추출 입력'),(123,'/admin/manage/config/prdmain_save.php','메인 상품추출 저장'),(124,'/admin/manage/config/prdmain_view.php','메인 상품추출 미리보기'),(125,'/admin/manage/config/product_config.php','상품관리'),(126,'/admin/manage/config/schedule_config.php','일정관리'),(127,'/admin/manage/config/sms_config.php','SMS 발송'),(128,'/admin/manage/connect','접속통계'),(129,'/admin/manage/connect/connect_keyword.php','검색키워드분석'),(130,'/admin/manage/connect/connect_list.php','접속자분석'),(131,'/admin/manage/connect/connect_param.php','분석파라미터 설정'),(132,'/admin/manage/connect/connect_refer.php','접속경로분석'),(133,'/admin/manage/connect/connect_save.php','초기화 및 파라미터 설정 저장'),(134,'/admin/manage/connect/left_menu.php','좌측메뉴'),(135,'/admin/manage/form','폼메일'),(136,'/admin/manage/form/down.php','첨부파일 다운로드'),(137,'/admin/manage/form/form_input.php','폼메일 입력'),(138,'/admin/manage/form/form_list.php','폼메일 목록'),(139,'/admin/manage/form/form_save.php','폼메일 저장'),(140,'/admin/manage/form/form_view.php','폼메일 보기'),(141,'/admin/manage/form/left_menu.php','좌측메뉴'),(142,'/admin/manage/image','이미지'),(143,'/admin/manage/image/bbs','게시판 이미지'),(144,'/admin/manage/image/day','달력 이미지'),(145,'/admin/manage/image/main','메인 이미지'),(146,'/admin/manage/image/tree','상품분류 트리 이미지'),(147,'/admin/manage/main','메인'),(148,'/admin/manage/main/left_menu.php','좌측메뉴'),(149,'/admin/manage/main/main.php','메인페이지'),(150,'/admin/manage/member','회원관리'),(151,'/admin/manage/member/id_check.php','아이디 중복검사'),(152,'/admin/manage/member/left_menu.php','좌측메뉴'),(153,'/admin/manage/member/level_input.php','회원등급 입력'),(154,'/admin/manage/member/level_list.php','회원등급 목록'),(155,'/admin/manage/member/level_save.php','회원등급 저장'),(156,'/admin/manage/member/mail_input.php','메세지설정 입력'),(157,'/admin/manage/member/mail_list.php','메세지설정 목록'),(158,'/admin/manage/member/mail_popup.php','메일발송 팝업'),(159,'/admin/manage/member/mail_save.php','메세지설정 저장'),(160,'/admin/manage/member/mail_send.php','단체메일발송'),(161,'/admin/manage/member/mail_set.php','메일 내용 세팅'),(162,'/admin/manage/member/mail_test.php','메일발송테스트'),(163,'/admin/manage/member/member_analy.php','회원통계'),(164,'/admin/manage/member/member_config.php','가입약관 및 개인정보 보호정책'),(165,'/admin/manage/member/member_excel.php','회원정보 엑셀 다운로드'),(166,'/admin/manage/member/member_input.php','회원정보 입력'),(167,'/admin/manage/member/member_list.php','회원목록'),(168,'/admin/manage/member/member_point.php','회원포인트 목록'),(169,'/admin/manage/member/member_save.php','회원 데이터 저장'),(170,'/admin/manage/member/message_input.php','쪽지 입력'),(171,'/admin/manage/member/message_list.php','쪽지 목록'),(172,'/admin/manage/member/message_save.php','쪽지 저장'),(173,'/admin/manage/member/message_send.php','쪽지발송'),(174,'/admin/manage/member/out_list.php','탈퇴회원'),(175,'/admin/manage/member/point_config.php','포인트 설정'),(176,'/admin/manage/member/point_list.php','포인트 목록'),(177,'/admin/manage/member/point_save.php','포인트 저장'),(178,'/admin/manage/member/search_zip.php','주소찾기'),(179,'/admin/manage/member/sms_popup.php','SMS 발송 팝업'),(180,'/admin/manage/member/sms_save.php','SMS 발송'),(181,'/admin/manage/member/sms_send.php','단체SMS발송'),(182,'/admin/manage/mini','미니홈피'),(183,'/admin/manage/mini/down.php','첨부파일 다운로드'),(184,'/admin/manage/mini/input.php','게시물 입력'),(185,'/admin/manage/mini/left_menu.php','좌측메뉴'),(186,'/admin/manage/mini/list.php','게시물목록'),(187,'/admin/manage/mini/mini_input.php','미니홈피 입력'),(188,'/admin/manage/mini/mini_list.php','미니홈피 목록'),(189,'/admin/manage/mini/mini_save.php','미니홈피 저장'),(190,'/admin/manage/mini/save.php','게시물 저장'),(191,'/admin/manage/mini/skin_input.php','스킨 입력'),(192,'/admin/manage/mini/skin_list.php','스킨 목록'),(193,'/admin/manage/mini/skin_save.php','스킨 저장'),(194,'/admin/manage/mini/url_check.php','미니홈피URL 중복체크'),(195,'/admin/manage/mini/view.php','게시글 보기'),(196,'/admin/manage/mini/view_img.php','첨부이미지 확대보기'),(197,'/admin/manage/page','페이지관리'),(198,'/admin/manage/page/left_menu.php','좌측메뉴'),(199,'/admin/manage/page/page_input.php','페이지 입력'),(200,'/admin/manage/page/page_list.php','페이지 목록'),(201,'/admin/manage/page/page_save.php','페이지 저장'),(202,'/admin/manage/poll','설문관리'),(203,'/admin/manage/poll/left_menu.php','좌측메뉴'),(204,'/admin/manage/poll/poll_input.php','설문조사 입력'),(205,'/admin/manage/poll/poll_list.php','설문조사 목록'),(206,'/admin/manage/poll/poll_question.php','설문내용 입력'),(207,'/admin/manage/poll/poll_save.php','설문조사 저장'),(208,'/admin/manage/poll/pollinfo_input.php','설문 입력'),(209,'/admin/manage/poll/pollinfo_list.php','설문 목록'),(210,'/admin/manage/poll/pollinfo_save.php','설문 저장'),(211,'/admin/manage/product','상품관리'),(212,'/admin/manage/product/cat_list.php','상품분류 목록'),(213,'/admin/manage/product/cat_save.php','상품분류 저장'),(214,'/admin/manage/product/left_menu.php','좌측메뉴'),(215,'/admin/manage/product/prd_cat.php','상품분류'),(216,'/admin/manage/product/prd_copy.php','상품 복사'),(217,'/admin/manage/product/prd_img.php','상품입력 > 상품사진'),(218,'/admin/manage/product/prd_imgsize.php','상품이미지사이즈 설정'),(219,'/admin/manage/product/prd_input.php','상품 입력'),(220,'/admin/manage/product/prd_list.php','상품 목록'),(221,'/admin/manage/product/prd_move.php','상품 이동'),(222,'/admin/manage/product/prd_save.php','상품 저장'),(223,'/admin/manage/schedule','일정관리'),(224,'/admin/manage/schedule/calendar.php','큰 달력'),(225,'/admin/manage/schedule/calendar_s.php','작은 달력'),(226,'/admin/manage/schedule/down.php','첨부파일 다운로드'),(227,'/admin/manage/schedule/input.php','일정 입력'),(228,'/admin/manage/schedule/left_menu.php','좌측메뉴'),(229,'/admin/manage/schedule/list.php','일정 목록'),(230,'/admin/manage/schedule/save.php','일정 저장'),(231,'/admin/manage/schedule/sch_input.php','일정정보 입력'),(232,'/admin/manage/schedule/sch_list.php','일정정보 목록'),(233,'/admin/manage/schedule/sch_save.php','일정정보 저장'),(234,'/admin/manage/schedule/schedule_s.php','관리자 메인 일정달력'),(235,'/admin/manage/schedule/view.php','일정 보기'),(236,'/admin/manage/schedule/view_img.php','첨부이미지 확대보기'),(237,'/admin/manage/db_backup.php','DB 백업'),(238,'/admin/manage/foot.php','관리자 하단'),(239,'/admin/manage/head.php','관리자 상단'),(240,'/admin/manage/site_info.php','사이트 기본정보'),(241,'/admin/member/skin','스킨 디렉토리'),(242,'/admin/member/id_check.php','아이디 중복체크'),(243,'/admin/member/idpw.php','아이디/비밀번호 찾기'),(244,'/admin/member/join_agree.php','회원가입 약관 및 개인정보 보호정책 동의'),(245,'/admin/member/join_ok.php','회원가입 완료'),(246,'/admin/member/login.php','로그인 페이지'),(247,'/admin/member/login_check.php','로그인 처리'),(248,'/admin/member/logout.php','로그아웃 처리'),(249,'/admin/member/myinfo.php','회원정보'),(250,'/admin/member/myinfo_save.php','회원정보 저장'),(251,'/admin/member/myout.php','회원탈퇴'),(252,'/admin/member/myout_save.php','회원탈퇴 처리'),(253,'/admin/member/name_check.php','실명인증'),(254,'/admin/member/nick_check.php','닉네임 중복체크'),(255,'/admin/member/post_search.php','우편번호 찾기'),(256,'/admin/message','쪽지'),(257,'/admin/message/skin','스킨 디렉토리'),(258,'/admin/message/down.php','첨부파일 다운로드'),(259,'/admin/message/friend.php','친구목록'),(260,'/admin/message/input.php','쪽지입력'),(261,'/admin/message/list.php','쪽지목록'),(262,'/admin/message/member.php','회원목록'),(263,'/admin/message/passwd.php','삭제확인 페이지'),(264,'/admin/message/pop_message.php','쪽지 보기 팝업'),(265,'/admin/message/save.php','쪽지 저장'),(266,'/admin/message/save_b.php','쪽지 저장 백업'),(267,'/admin/message/view.php','쪽지 보기'),(268,'/admin/message/view_img.php','첨부이미지 확대보기'),(269,'/admin/mini/bbs','게시판'),(270,'/admin/mini/bbs/skin','스킨 디렉토리'),(271,'/admin/mini/bbs/comment.php','코멘트'),(272,'/admin/mini/bbs/down.php','첨부파일 다운로드'),(273,'/admin/mini/bbs/input.php','입력페이지'),(274,'/admin/mini/bbs/list.php','목록페이지'),(275,'/admin/mini/bbs/move.php','게시물 이동'),(276,'/admin/mini/bbs/passwd.php','비밀번호 체크'),(277,'/admin/mini/bbs/save.php','데이터저장'),(278,'/admin/mini/bbs/view.php','보기페이지'),(279,'/admin/mini/bbs/view_img.php','첨부이미지 확대보기'),(280,'/admin/mini/image','이미지 디렉토리'),(281,'/admin/mini/inc','인클루드 디렉토리'),(282,'/admin/mini/inc/mini_connect.php','미니홈피 로그분석'),(283,'/admin/mini/inc/mini_info.php','미니홈피 정보'),(284,'/admin/mini/inc/minibbs_info.php','미니홈피 게시판 정보'),(285,'/admin/mini/makeucc','UCC 컴포넌트'),(286,'/admin/mini/makeucc/example','UCC 예제'),(287,'/admin/mini/makeucc/example/board','UCC 게시판'),(288,'/admin/mini/makeucc/example/board/db','UCC DB 처리'),(289,'/admin/mini/makeucc/example/board/img','UCC 게시판 이미지'),(290,'/admin/mini/makeucc/view_file.php','UCC 파일 정보 전달'),(291,'/admin/mini/music','미니홈피 음악'),(292,'/admin/mini/music/img','이미지 디렉토리'),(293,'/admin/mini/add_friend.php','친구 추가'),(294,'/admin/mini/admin_connect.php','관리 > 접속통계'),(295,'/admin/mini/admin_friend.php','관리 > 친구관리'),(296,'/admin/mini/admin_info.php','관리 > 기본설정'),(297,'/admin/mini/admin_left.php','관리 > 좌측메뉴'),(298,'/admin/mini/admin_menu.php','관리 > 메뉴설정'),(299,'/admin/mini/admin_menu_config.php','관리 > 메뉴설정 > 메뉴관리'),(300,'/admin/mini/admin_music.php','관리 > 음악설정'),(301,'/admin/mini/admin_music_input.php','음악입력'),(302,'/admin/mini/admin_profile.php','관리 > 프로필'),(303,'/admin/mini/admin_skin.php','관리 > 스킨설정'),(304,'/admin/mini/admin_skin_input.php','스킨입력'),(305,'/admin/mini/bbs.php','게시판'),(306,'/admin/mini/bbs_left.php','게시판 좌측메뉴'),(307,'/admin/mini/data.php','자료실'),(308,'/admin/mini/data_left.php','자료실 좌측메뉴'),(309,'/admin/mini/foot.php','하단파일'),(310,'/admin/mini/guest.php','방명록'),(311,'/admin/mini/head.php','상단파일'),(312,'/admin/mini/info.php','프로필 > 내소개'),(313,'/admin/mini/info_input.php','내소개 입력'),(314,'/admin/mini/info_list.php','내소개 목록'),(315,'/admin/mini/main.php','메인페이지'),(316,'/admin/mini/main_content.php','메인페이지 내용'),(317,'/admin/mini/main_left.php','메인페이지 좌측메뉴'),(318,'/admin/mini/menu.php','우측메뉴'),(319,'/admin/mini/mini_index.php','미니홈피 인덱스'),(320,'/admin/mini/mini_my.php','내 미니홈피가기'),(321,'/admin/mini/movie.php','동영상'),(322,'/admin/mini/movie_left.php','동영상 좌측메뉴'),(323,'/admin/mini/photo.php','갤러리'),(324,'/admin/mini/photo_left.php','갤러리 좌측메뉴'),(325,'/admin/mini/profile.php','프로필'),(326,'/admin/mini/profile_left.php','프로필 좌측메뉴'),(327,'/admin/mini/save.php','데이터저장'),(328,'/admin/mini/url_check.php','미니홈피 URL 중복체크'),(329,'/admin/module','모듈'),(330,'/admin/module/banner.php','배너 모듈'),(331,'/admin/module/bbs.php','게시판 모듈'),(332,'/admin/module/bbsmain.php','메인게시물 모듈'),(333,'/admin/module/connect.php','로그분석 모듈'),(334,'/admin/module/counter.php','카운터 모듈'),(335,'/admin/module/form.php','폼메일 모듈'),(336,'/admin/module/idpw.php','아이디/비밀번호 찾기 모듈'),(337,'/admin/module/join.php','회원가입 모듈'),(338,'/admin/module/levelcheck.php','페이지접근권한 모듈'),(339,'/admin/module/login.php','로그인 모듈'),(340,'/admin/module/loginbox.php','로그인박스 모듈'),(341,'/admin/module/msg_count.php','쪽지갯수 모듈'),(342,'/admin/module/msg_friend.php','친구목록 모듈'),(343,'/admin/module/msg_member.php','회원목록 모듈'),(344,'/admin/module/msg_receive.php','받은쪽지 모듈'),(345,'/admin/module/msg_send.php','보낸쪽지 모듈'),(346,'/admin/module/myinfo.php','회원정보수정 모듈'),(347,'/admin/module/myout.php','회원탈퇴 모듈'),(348,'/admin/module/mypoint.php','회원 포인트내역 모듈'),(349,'/admin/module/page.php','페이지 모듈'),(350,'/admin/module/point.php','포인트 모듈'),(351,'/admin/module/poll.php','설문조사 모듈'),(352,'/admin/module/pollmain.php','메인설문조사 모듈'),(353,'/admin/module/popup.php','팝업 모듈'),(354,'/admin/module/prdmain.php','상품메인추출 모듈'),(355,'/admin/module/product.php','상품 모듈'),(356,'/admin/module/schedule.php','일정(대) 모듈'),(357,'/admin/module/schedule_s.php','일정(소) 모듈'),(358,'/admin/module/sms.php','SMS발송 모듈'),(359,'/admin/module/topjoin.php','로그인/로그아웃 탑메뉴 모듈'),(360,'/admin/module/toplogin.php','회원가입/마이페이지 탑메뉴 모듈'),(361,'/admin/point','포인트'),(362,'/admin/point/skin','스킨 디렉토리'),(363,'/admin/point/mypoint.php','포인트내역'),(364,'/admin/poll','설문조사'),(365,'/admin/poll/skin','스킨 디렉토리'),(366,'/admin/poll/list.php','목록 페이지'),(367,'/admin/poll/passwd.php','비밀번호 체크'),(368,'/admin/poll/save.php','데이터저장'),(369,'/admin/poll/view.php','보기 페이지'),(370,'/admin/popup','팝업'),(371,'/admin/popup/popup.php','일반 팝업'),(372,'/admin/popup/popup_layer.php','레이어 팝업'),(373,'/admin/product','상품'),(374,'/admin/product/skin','스킨 디렉토리'),(375,'/admin/product/list.php','목록 페이지'),(376,'/admin/product/prdimg.php','상품이미지 확대보기'),(377,'/admin/product/view.php','보기 페이지'),(378,'/admin/schedule','일정'),(379,'/admin/schedule/skin','스킨 디렉토리'),(380,'/admin/schedule/comment.php','코멘트'),(381,'/admin/schedule/down.php','첨부파일 다운로드'),(382,'/admin/schedule/input.php','입력페이지'),(383,'/admin/schedule/list.php','목록페이지'),(384,'/admin/schedule/list_s.php','목록페이지(소)'),(385,'/admin/schedule/passwd.php','비밀번호체크'),(386,'/admin/schedule/save.php','데이터저장'),(387,'/admin/schedule/view.php','보기페이지'),(388,'/admin/schedule/view_img.php','첨부이미지 확대보기'),(389,'/admin/sms','SMS 발송'),(390,'/admin/sms/image','이미지 디렉토리'),(391,'/admin/sms/input.php','입력 페이지'),(392,'/admin/sms/send.php','발송 페이지'),(393,'/admin/webedit','웹에디터'),(394,'/admin/webedit/PopupWin','팝업 페이지'),(395,'/admin/webedit/PopupWin/Editor_Help.htm','웹에디터 도움말'),(396,'/admin/webedit/PopupWin/Editor_InsertFlash.htm','플래쉬 입력'),(397,'/admin/webedit/PopupWin/Editor_InsertImage.htm','이미지 입력'),(398,'/admin/webedit/PopupWin/Editor_InsertMovie.htm','동영상 입력'),(399,'/admin/webedit/PopupWin/Editor_InsertTable.htm','테이블 입력'),(400,'/admin/webedit/PopupWin/Editor_SelectColor.htm','색상 선택'),(401,'/admin/webedit/PopupWin/Editor_Version.htm','웹에디터 버전'),(402,'/admin/webedit/PopupWin/Editor_InsertFlash.php','플래쉬 저장'),(403,'/admin/webedit/PopupWin/Editor_InsertImage.php','이미지 저장'),(404,'/admin/webedit/PopupWin/Editor_InsertMovie.php','동영상 저장'),(405,'/admin/webedit/images','이미지 디렉토리'),(406,'/admin/common.php','설정파일'),(407,'/admin/dbcon.php','DB 접속 정보'),(408,'/admin/desc_file.php','파일구조'),(409,'/admin/desc_table.php','디비스키마'),(410,'/admin/index.php','관리자 인덱스페이지'),(411,'/admin/install.php','솔루션 설치 정보 입력'),(412,'/admin/install_ok.php','솔루션 설치'),(413,'/admin/lib.php','함수선언'),(414,'/admin/login.php','관리자 로그인'),(415,'/admin/logout.php','관리자 로그아웃'),(416,'/admin/phpinfo.php','PHP 정보 phpinfo()'),(417,'/admin/query.php','쿼리문'),(418,'/admin/site_key.php','라이센스키 입력'),(419,'/admin/manage/bbs/group.php','게시판그룹 목록'),(420,'/admin/manage/bbs/group_input.php','게시판그룹 입력'),(421,'/admin/manage/bbs/list_b.php','게시물 목록 백업'),(422,'/admin/manage/config/prd_config.php','상품관리'),(423,'/admin/manage/config/prdmain_config.php','메인상품관리'),(424,'/admin/bbs/order.php','게시물 순서변경'),(425,'/admin/manage/bbs/bbs.php','게시판'),(426,'/admin/desc_file_b.php','파일구조 백업');
...
INSERT INTO `wiz_mailsms` VALUES ('mem_join','MEM','회원가입시','Y','[{SITE_NAME}] 회원님 가입해주셔서 감사합니다.','[{SITE_NAME}] - {MEM_NAME} 회원님 가입해주셔서 감사합니다.','Y','<STYLE>\r\n  td {font-size:12px;font-family:\'굴림\',\'돋움\';color:#4A4A4A;line-height:160%} \r\n  table {border-collapse:collapse;}\r\n</STYLE>\r\n\r\n<TABLE height=\'100%\' cellSpacing=0 cellPadding=0 width=642 align=center border=0>\r\n<TBODY>\r\n<TR>\r\n<TD align=middle>\r\n<TABLE cellSpacing=0 cellPadding=0 border=0>\r\n<TBODY>\r\n<TR>\r\n<TD><IMG src=\'{SITE_URL}/admin/mail/img/top_02.gif\'></TD></TR>\r\n<TR>\r\n<TD background={SITE_URL}/admin/mail/img/bg_line.gif>\r\n<TABLE cellSpacing=0 cellPadding=0 width=642 border=0>\r\n<TBODY>\r\n<TR>\r\n<TD style=\'PADDING-RIGHT: 30px; PADDING-LEFT: 30px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px\'>회원님 가입해주셔서 감사합니다.<BR><BR>아이디 : {MEM_ID}</TD>\r\n<TD vAlign=bottom align=right width=190><IMG src=\'{SITE_URL}/admin/mail/img/img_06.gif\'></TD></TR></TBODY></TABLE></TD></TR>\r\n<TR>\r\n<TD><IMG src=\'{SITE_URL}/admin/mail/img/bottom.gif\'></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>','2007-01-01'),('mem_out','MEM','회원탈퇴시','Y','[{SITE_NAME}] 회원님 탈퇴처리 되었습니다. 불편을드려 죄송합니다','[{SITE_NAME}] -  {MEM_NAME}회원님 탈퇴처리되었습니다.','Y','<STYLE>\r\n  td {font-size:12px;font-family:\'굴림\',\'돋움\';color:#4A4A4A;line-height:160%} \r\n  table {border-collapse:collapse;}\r\n</STYLE>\r\n\r\n<TABLE height=\'100%\' cellSpacing=0 cellPadding=0 width=642 align=center border=0>\r\n<TBODY>\r\n<TR>\r\n<TD align=middle>\r\n<TABLE cellSpacing=0 cellPadding=0 border=0>\r\n<TBODY>\r\n<TR>\r\n<TD><IMG src=\'{SITE_URL}/admin/mail/img/top_03.gif\'></TD></TR>\r\n<TR>\r\n<TD background={SITE_URL}/admin/mail/img/bg_line.gif>\r\n<TABLE cellSpacing=0 cellPadding=0 width=642 border=0>\r\n<TBODY>\r\n<TR>\r\n<TD style=\'PADDING-RIGHT: 30px; PADDING-LEFT: 30px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px\'>회원님 탈퇴처리 되었습니다. 불편을드려 죄송합니다 </TD>\r\n<TD vAlign=bottom align=right width=190><IMG src=\'{SITE_URL}/admin/mail/img/img_06.gif\'></TD></TR></TBODY></TABLE></TD></TR>\r\n<TR>\r\n<TD><IMG src=\'{SITE_URL}/admin/mail/img/bottom.gif\'></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>','2007-01-02'),('basic','','일반 메일 발송시','','','','','<STYLE>\r\n  td {font-size:12px;font-family:굴림,돋움;color:#4A4A4A;line-height:160%} \r\n  table {border-collapse:collapse;}\r\n</STYLE>\r\n\r\n<TABLE height=100% cellSpacing=0 cellPadding=0 width=642 align=center border=0>\r\n<TBODY>\r\n<TR>\r\n<TD align=middle>\r\n<TABLE cellSpacing=0 cellPadding=0 border=0>\r\n<TBODY>\r\n<TR>\r\n<TD><IMG src={SITE_URL}/admin/mail/img/top_01.gif></TD></TR>\r\n<TR>\r\n<TD background={SITE_URL}/admin/mail/img/bg_line.gif>\r\n<TABLE cellSpacing=0 cellPadding=0 width=642 border=0>\r\n<TBODY>\r\n<TR>\r\n<TD style=\'PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px\'></TD></TR></TBODY></TABLE></TD></TR>\r\n<TR>\r\n<TD><IMG src={SITE_URL}/admin/mail/img/bottom.gif></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>','2007-01-05'),('mem_idpw','MEM','아이디/비밀번호 찾기','Y','[{SITE_NAME}] 회원님의 아이디는 {MEM_ID} 입니다.','[{SITE_NAME}] -  {MEM_NAME}회원님이 요청하신 정보 입니다.','Y','<style>\r\n  td {font-size:12px;font-family:\"굴림\",\"돋움\";color:#4A4A4A;line-height:160%} \r\n  table {border-collapse:collapse;}</style>\r\n<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"642\" align=\"center\" height=\"100%\">\r\n<tbody>\r\n<tr>\r\n<td align=\"center\">\r\n<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n<tbody>\r\n<tr>\r\n<td><img alt=\"\" src=\"{SITE_URL}/admin/mail/img/top_04.gif\" /></td></tr>\r\n<tr>\r\n<td background=\"{SITE_URL}/admin/mail/img/bg_line.gif\">\r\n<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"642\">\r\n<tbody>\r\n<tr>\r\n<td style=\"padding-bottom: 10px; padding-left: 30px; padding-right: 30px; padding-top: 10px\">회원님이 요청하신 아이디입니다.<br /><br />아이디 : {MEM_ID}</td>\r\n<td valign=\"bottom\" width=\"190\" align=\"right\"><img alt=\"\" src=\"{SITE_URL}/admin/mail/img/img_06.gif\" /></td></tr></tbody></table></td></tr>\r\n<tr>\r\n<td><img alt=\"\" src=\"{SITE_URL}/admin/mail/img/bottom.gif\" /></td></tr></tbody></table></td></tr></tbody></table>','2007-01-04'),('bbs','BBS','게시판 답변메일','','','','','<STYLE>\r\n  td {font-size:12px;font-family:\'굴림\',\'돋움\';color:#4A4A4A;line-height:160%} \r\n  table {border-collapse:collapse;}\r\n</STYLE>\r\n\r\n<TABLE height=\'100%\' cellSpacing=0 cellPadding=0 width=642 align=center border=0>\r\n<TBODY>\r\n<TR>\r\n<TD align=middle>\r\n<TABLE cellSpacing=0 cellPadding=0 border=0>\r\n<TBODY>\r\n<TR>\r\n<TD><IMG src=\'{SITE_URL}/admin/mail/img/top_01.gif\'></TD></TR>\r\n<TR>\r\n<TD background={SITE_URL}/admin/mail/img/bg_line.gif>\r\n<TABLE cellSpacing=0 cellPadding=0 width=642 border=0>\r\n<TBODY>\r\n<TR>\r\n<TD style=\'PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px\'>{MESSAGE}</TD></TR></TBODY></TABLE></TD></TR>\r\n<TR>\r\n<TD><IMG src=\'{SITE_URL}/admin/mail/img/bottom.gif\'> </TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>','2007-01-05'),('mailling','ADD','1월 정기 웹진 - 테스트','','','','','1월 정기 웹진 - 테스트','2007-01-06'),('mem_id','MEM','아이디 찾기','Y','[{SITE_NAME}] 회원님의 아이디는 {MEM_ID} 입니다.','[{SITE_NAME}] -  {MEM_NAME}회원님이 요청하신 정보 입니다.','Y','<STYLE>\r\n  td {font-size:12px;font-family:\'굴림\',\'돋움\';color:#4A4A4A;line-height:160%} \r\n  table {border-collapse:collapse;}\r\n</STYLE>\r\n\r\n<TABLE height=\'100%\' cellSpacing=0 cellPadding=0 width=642 align=center border=0>\r\n<TBODY>\r\n<TR>\r\n<TD align=middle>\r\n<TABLE cellSpacing=0 cellPadding=0 border=0>\r\n<TBODY>\r\n<TR>\r\n<TD><IMG src=\'{SITE_URL}/admin/mail/img/top_04.gif\'></TD></TR>\r\n<TR>\r\n<TD background={SITE_URL}/admin/mail/img/bg_line.gif>\r\n<TABLE cellSpacing=0 cellPadding=0 width=642 border=0>\r\n<TBODY>\r\n<TR>\r\n<TD style=\'PADDING-RIGHT: 30px; PADDING-LEFT: 30px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px\'>회원님이 요청하신 아이디입니다.<BR><BR>아이디 : {MEM_ID}</TD>\r\n<TD vAlign=bottom align=right width=190><IMG src=\'{SITE_URL}/admin/mail/img/img_06.gif\'></TD></TR></TBODY></TABLE></TD></TR>\r\n<TR>\r\n<TD><IMG src=\'{SITE_URL}/admin/mail/img/bottom.gif\'></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>','2007-01-04'),('mem_pw','MEM','비밀번호 찾기','Y','[{SITE_NAME}] 회원님의 비밀번호는 {MEM_PW} 입니다.','[{SITE_NAME}] -  {MEM_NAME}회원님이 요청하신 정보 입니다.','Y','<STYLE>\r\n  td {font-size:12px;font-family:\'굴림\',\'돋움\';color:#4A4A4A;line-height:160%} \r\n  table {border-collapse:collapse;}\r\n</STYLE>\r\n\r\n<TABLE height=\'100%\' cellSpacing=0 cellPadding=0 width=642 align=center border=0>\r\n<TBODY>\r\n<TR>\r\n<TD align=middle>\r\n<TABLE cellSpacing=0 cellPadding=0 border=0>\r\n<TBODY>\r\n<TR>\r\n<TD><IMG src=\'{SITE_URL}/admin/mail/img/top_04.gif\'></TD></TR>\r\n<TR>\r\n<TD background={SITE_URL}/admin/mail/img/bg_line.gif>\r\n<TABLE cellSpacing=0 cellPadding=0 width=642 border=0>\r\n<TBODY>\r\n<TR>\r\n<TD style=\'PADDING-RIGHT: 30px; PADDING-LEFT: 30px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px\'>회원님이 요청하신 비밀번호 입니다.<BR><BR>비밀번호 : {MEM_PW}</TD>\r\n<TD vAlign=bottom align=right width=190><IMG src=\'{SITE_URL}/admin/mail/img/img_06.gif\'></TD></TR></TBODY></TABLE></TD></TR>\r\n<TR>\r\n<TD><IMG src=\'{SITE_URL}/admin/mail/img/bottom.gif\'></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>','2007-01-04'),('form','FRM','폼메일 답변메일','','','','','<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"642\" align=\"center\" height=\"100%\">\r\n<tbody>\r\n<tr>\r\n<td align=\"center\">\r\n<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n<tbody>\r\n<tr>\r\n<td><img alt=\"\" src=\"{SITE_URL}/admin/mail/img/top_01.gif\" /></td></tr>\r\n<tr>\r\n<td background=\"{SITE_URL}/admin/mail/img/bg_line.gif\">\r\n<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"642\">\r\n<tbody>\r\n<tr>\r\n<td style=\"padding-bottom: 10px; padding-left: 10px; padding-right: 10px; padding-top: 10px\">{MESSAGE}</td></tr></tbody></table></td></tr>\r\n<tr>\r\n<td><img alt=\"\" src=\"{SITE_URL}/admin/mail/img/bottom.gif\" /> </td></tr></tbody></table></td></tr></tbody></table>',NULL);
