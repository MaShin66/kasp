...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center" bgcolor="#f9f9f9" height="30" style="padding-left:10px; border-right:1px solid #d7d7d7;"><strong>예약일</strong></td>
    <td align="left" style="padding-left:10px; border-right:1px solid #d7d7d7;"><?=$addinfo1?>년 <?=$addinfo2?>월 <?=$addinfo3?>일 <?=$addinfo4?>시 ~ <?=$addinfo5?>시</td>
