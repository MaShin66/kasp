...
function imageDelete(filePath) {
	...
	formData.append("filepath", encodeURI(filePath));
...
function imgComplete(img, imgSize, boxId) {
	...
	// console.log('ShowThumbnailSize:',ShowThumbnailSize)
	...
	if (resizeW > ShowThumbnailSize.width) {
		resizeW = ShowThumbnailSize.width;
	}

	if (resizeH > ShowThumbnailSize.height) {
		resizeH = ShowThumbnailSize.height;
	}
	...
	// console.log('img.style:',resizeW, resizeH)
