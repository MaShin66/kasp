...
//-->
      ...
      <form name="frm" action="point_save.php" method="post" enctype="multipart/form-data" onSubmit="return inputCheck(this);">
        ...
        <tr>
          ...
          <td class="t_value" align="left">
          <?
          $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin/module/mypoint.php\";     // 회원포인트내역 ?&gt;";
          ?>
          <script language="javascript">
        ...
        <tr>
          ...
          <td class="t_value" align="left">
          <?
          $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin/module/point.php\";     // 포인트 ?&gt;";
          ?>
          <script language="javascript">
