...
function phpCode(code){
	var php_code = "&lt;? \$code=\""+code+"\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin/module/pollmain.php\"; // 설문조사 ?&gt;";
          ...
          <td>
            <table width="100%" border="0" cellspacing="1" cellpadding="6" class="t_style">
              <tr>
                ...
                <?
                $php_code = "&lt;? \$code=\"poll\"; include \"\$_SERVER[DOCUMENT_ROOT]/admin/module/pollmain.php\";     // 설문조사 ?&gt;";
                ?>
                <script language="javascript">
