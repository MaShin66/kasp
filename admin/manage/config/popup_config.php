...
<? include "../head.php"; ?>
          ...
          <td>
            <table width="100%" border="0" cellspacing="1" cellpadding="6" class="t_style">
              <tr>
                ...
                <?
                $php_code = "&lt;? include \"\$_SERVER[DOCUMENT_ROOT]/admin/module/popup.php\";     // 팝업관리 ?&gt;";
                ?>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="6">
        <tr>
          <td bgcolor="#ffffff">
<br>
<font color=blue>&lt;? include "$_SERVER[DOCUMENT_ROOT]/admin/module/popup.php";     // 팝업관리 ?&gt;</font><br>
      ...
      <br><br>
        ...
        <tr>
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="6">
            ...
            <tr>
              <td class="chk_alt">
              - 스킨위치 : /admin/popup/popup.php, popup_layer.php<br>
