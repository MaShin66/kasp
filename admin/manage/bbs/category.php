...
?>
	<tr>
		...
		<td align="center">
			<?php if(!empty($row[catimg])) { ?> <img src="/admin/data/category/<?=$code?>/<?=$row[catimg]?>"><?php } ?>
		</td>
		<td align="center">
			<?php if(!empty($row[catimg_over])) { ?> <img src="/admin/data/category/<?=$code?>/<?=$row[catimg_over]?>"><?php } ?>
		</td>
		<td align="center">
			<?php if(!empty($row[caticon])) { ?> <img src="/admin/data/category/<?=$code?>/<?=$row[caticon]?>"><?php } ?>
		</td>
