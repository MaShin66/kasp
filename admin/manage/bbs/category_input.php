...
?>
			<br> <img src="/admin/data/category/<?=$code?>/<?=$cat_info[catimg]?>">
...
?>
			<br> <img src="/admin/data/category/<?=$code?>/<?=$cat_info[catimg_over]?>">
...
?>
			<br> <img src="/admin/data/category/<?=$code?>/<?=$cat_info[caticon]?>">
